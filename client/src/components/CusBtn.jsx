...
const CusBtn = ({ theme, content, style, w, action, type = 'button' }) => {
	const btnStyles = {
		primary: `bg-primary text-light border-none border-primary hover:outline-none hover:bg-primdark focus:outline-none w-${w} shadow-md`,
		...
		fourth: `bg-light text-dark border-none border-primary hover:outline-none hover:bg-white focus:outline-none w-${w}`,
	};
	return (
