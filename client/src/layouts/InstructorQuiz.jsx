			...
			<>
				<section className='font-lexend flex flex-col gap-8'>
					<div className='flex flex-col gap-3'>
						...
						<div className='bg-light p-3 flex lg:flex-row rounded-xl shadow-custom flex-col font-light text-sm gap-2 w-full'>
							<Setting
							...
							return (
								...
								>
									<div className='gap-1 mb-2'>
										<div className='flex flex-row gap-2 bg-primary-1 p-2 rounded-lg uppercase items-center text-md'>
											<img
													...
													actions={
														<div className='flex flex-row justify-between gap-2 items-center'>
															<button
																...
																className='flex bg-brown-light w-full p-2  hover:border-amber-900 focus:no-outline'
															>
															...
															<button
																...
																className='bg-blue-light p-2 w-full hover:border-green-900 focus:no-outline'
															>
																<div className='flex w-full items-center text-center gap-1 justify-center'>
																	<svg
																		xmlns='http://www.w3.org/2000/svg'
															...
															<button
																...
																className='bg-red-light  w-full hover:border-red-700'
															>
																<div className='flex w-full items-center text-center gap-1 justify-center focus:no-outline'>
																	<svg
																		xmlns='http://www.w3.org/2000/svg'
																		fill='none'
																		viewBox='0 0 24 24'
